	...
	*/
	...
	for(int y=streetlevel+1;y<=streetlevel+2;y++){
		...
		*/
		...
		//Blocking the middle rooms
		worldgrid[house_low_x+7][y][house_low_z+2][0]=interior_wallcorner_tile_l;
		worldgrid[house_low_x+7][y][house_low_z+2][1]=0;
		worldgrid[house_low_x+8][y][house_low_z+2][0]=interior_wallcorner_tile_l;
		worldgrid[house_low_x+8][y][house_low_z+2][1]=0;
		worldgrid[house_low_x+2][y][house_low_z+7][0]=interior_wallcorner_tile_l;
		worldgrid[house_low_x+2][y][house_low_z+7][1]=1;
		worldgrid[house_low_x+2][y][house_low_z+8][0]=interior_wallcorner_tile_l;
		worldgrid[house_low_x+2][y][house_low_z+8][1]=1;
		...
		worldgrid[house_low_x+8][y][house_high_z-2][1]=2;
		worldgrid[house_high_x-2][y][house_low_z+8][0]=interior_wallcorner_tile_l;
		worldgrid[house_high_x-2][y][house_low_z+8][1]=3;
		worldgrid[house_high_x-2][y][house_low_z+7][0]=interior_wallcorner_tile_l;
		worldgrid[house_high_x-2][y][house_low_z+7][1]=3;
